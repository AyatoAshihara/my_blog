...
d_allocation <- function(weight,title){
...
d_allocation(CCC$weight,"CCC")
d_allocation(DCC$weight,"DCC")
d_allocation(DECO$weight,"DECO")
...
d_allocation(DCC$weight,"DCC")
d_allocation(DECO$weight,"DECO")
d_allocation(benchmark$weight,"benchmark")
