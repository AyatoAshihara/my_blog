...
ここまでをRで実装したいと思います。まず、カルマンフィルタと事前分布を定義します。
...
では、varsパッケージに準備されているCanadaデータを使用して、BVARをやってみます。これはカナダの1980～2000年の労働生産性、雇用、失業率、実質賃金をまとめたものになります。
まずは、通常のVARからやりたいと思います。
