...
という風に基底関数$\phi(\textbf{x}_{i})$をかませて拡張します。$\phi(・)$は平均$\textbf{0}$、分散共分散行列$\textbf{K}_{\textbf{x}}$のガウス過程と仮定します。分散共分散行列$\textbf{K}_{\textbf{x}}$は
...
残った積分を見ると、正規分布の正規化手数と等しいことがわかります。
