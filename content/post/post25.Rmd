...
```{python,include=FALSE}
img = Image.open(r'C:\Users\aashi\Desktop\my_blog\static\img\portfolio\ＮＨＫマイルＣ_レシステンシア　評価Ｂ.jpg')
mask = Image.open(r'C:\Users\aashi\Desktop\my_blog\static\img\portfolio\mask.jpg')
outImage = Image.open(r'C:\Users\aashi\Desktop\my_blog\static\img\portfolio\ＮＨＫマイルＣ_レシステンシア　評価Ｂ削除.jpg')
```
```{python}
plt.gray()
...
![フォルダ](/my_blog\post\post25_files\maskhorse.PNG)
...
shap.image_plot(shap_values[1],X_test[[1]])
```
